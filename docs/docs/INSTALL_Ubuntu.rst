...
- ravada_1.3.3_ubuntu-18.04_all.deb
- ravada_1.3.3_ubuntu-20.04_all.deb

When you run dpkg now it may show some errors, it is ok, keep reading.

.. prompt:: bash $

     wget http://infoteleco.upc.edu/img/debian/ravada_1.3.3_ubuntu-20.04_all.deb
     sudo apt install ./ravada_1.3.3_ubuntu-20.04_all.deb
