...
- ravada_2.3.3_ubuntu-18.04_all.deb
- ravada_2.3.3_ubuntu-20.04_all.deb for Ubuntu 20.04 and Ubuntu 22.04

When you run dpkg now it may show some errors, it is ok, keep reading.

.. prompt:: bash $

     wget http://infoteleco.upc.edu/img/debian/ravada_2.3.3_ubuntu-20.04_all.deb
     sudo apt-get update
     sudo apt install ./ravada_2.3.3_ubuntu-20.04_all.deb
