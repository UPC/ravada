...
if [[ $OS = *"Ubuntu"* && $VER > '16.04' ]]; then
  ...
  wget http://infoteleco.upc.edu/img/debian/ravada_1.8.2_ubuntu-18.04_all.deb
  sudo dpkg -i ravada_1.8.2_ubuntu-18.04_all.deb &> /dev/null
  ...
  wget http://infoteleco.upc.edu/img/debian/ravada_1.8.2_all.deb &> /dev/null
  sudo dpkg -i ravada_1.8.2_all.deb &> /dev/null
  echo "Installing Dependencies..."
  sudo apt-get update -y &> /dev/null
  sudo apt-get -f -y install &> /dev/null
